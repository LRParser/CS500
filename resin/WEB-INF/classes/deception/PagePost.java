...
public class PagePost {
	...
	public PagePost(int id, Date update_date, String name ,String reactions, int shares_count, String message, int page_id)
	{
		this.id = id ; this.update_date = update_date;
		this.name = name; this.reactions = reactions; this.shares_count = shares_count;
		this.message = message; this.page_id = page_id;
	}
