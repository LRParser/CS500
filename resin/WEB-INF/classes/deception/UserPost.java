...
public class UserPost {
	...
	public UserPost(int id, Date update_date, String name ,String reactions, int shares_count, String message, int user_id)
	{
		this.id = id ; this.update_date = update_date;
		this.name = name; this.reactions = reactions; this.shares_count = shares_count;
		this.message = message; this.user_id = user_id;
	}
